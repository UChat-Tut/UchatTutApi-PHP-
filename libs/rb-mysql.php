...
namespace RedBeanPHP\Driver {
    ...
    class RPDO implements Driver
    {
         ...
         *
         * @param string|ObjectClass $dsn database connection string
...
namespace RedBeanPHP {
    ...
    /**
     * OODBBean (Model Oriented DataBase Bean).
     *
...
namespace RedBeanPHP\QueryWriter {
    ...
    abstract class AQueryWriter
    {
         ...
         * Not part of the Model Database interface!
         *
...
namespace RedBeanPHP {
	 ...
	 */
        ...
        /**
         * Dispenses a new bean (a OODBBean Bean Model)
         ...
         * OODBBean Bean Model $bean and stores it
...
namespace RedBeanPHP\Repository {
    ...
    class Fluid extends Repository
    {
         ...
         * It searches for a OODBBean Bean Model in the
...
namespace RedBeanPHP {
    ...
    /**
     * RedBean Model Oriented DataBase.
     *
...
namespace RedBeanPHP {
    ...
    class ToolBox
    {
         ...
         *
         * @param OODB $oodb Model Database, OODB
...
namespace RedBeanPHP {
     ...
     * The Bean Helper is passed to the OODB RedBeanPHP Model to
...
namespace RedBeanPHP {
    ...
    class Facade
    {
        ...
        /**
         * Configures the facade, want to have a new Writer? A new Model Database or a new
         ...
         * The RedBeanPHP Model oriented database is the main RedBeanPHP
         * interface that allows you to store and retrieve RedBeanPHP
         * objects (i.e. beans).
         *
         * @param OODB $redbean Model Database for facade to use
         */
...
namespace RedBeanPHP\Util {
     ...
     * been decided to remove unique features to service models like
...
//make some models available for backward compatibility
